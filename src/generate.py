...
if __name__ == '__main__':
    ...
    output_idx = None #range(0, 16) #only for multi
    #model_path = '../../Sal_dist/pretrained/d1d2d3_S_lt.pth'
    model_path = '../weights/d123s_rc2_rc1T.pth'
    #model_path = '../weights/d123s_rc4_rc1T.pth'
    #model_path = '../../Sal_dist/pretrained/d1d2d3_M_lt.pth'
    #model_path = '../weights/d123m_rc2_rc1T.pth'
    #model_path = '../weights/d123m_rc4_rc1T.pth'
